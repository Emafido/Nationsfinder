...
export default function Home() {
  return (
    <div className="px-2 py-5 bg-white md:px-0">
        ...
        <div className="flex flex-wrap items-center sm:-mx-3">
          <div className="w-full md:w-1/2 md:px-3">
            <div className="space-y-6 sm:max-w-md lg:max-w-lg">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 space-x-2 sm:text-5xl">
              ...
              <div className="flex flex-col gap-3 mb-3 sm:flex-row sm:space-x-4">
                <Link
                  to="/countries"
